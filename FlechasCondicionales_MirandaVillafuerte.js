...
const gener = (nombre,año)=> `Hola ${nombre},tienes ${año} años de edad`
console.log(gener("Laura","15"));
...
const cmilla = input => (input*1.60934);
console.log(cmilla(18))
...
const cl = input => input == "Lluvioso"?"Llevar un paraguas": input=="Soleado"?"Llevar un sombrero":"Se precavido"
console.log(cl("Lluvioso"));