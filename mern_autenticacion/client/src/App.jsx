...
const[registro,setregistro]=useState(false)
  ...
  return (
    <>
    <hr />
      {login && <button className="btn btn-warning" onClick={logOut}>Log out</button>}
      <hr />

    {(login)?
    <><Link to={'canciones'}>Todas las canciones </Link>|<Link to={'/canciones/new'}>Crear nueva canción </Link>|
