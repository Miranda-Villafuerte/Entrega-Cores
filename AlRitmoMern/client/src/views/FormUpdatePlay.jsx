...
const FormUpdatePlay = ({ listplaylist, setlistplaylist }) => {
    ...
    const URLCAN = "http://localhost:8082/api/cancion";
    const URLPLAY = "http://localhost:8082/api/playlist";
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="btn btn-warning" type="submit">Actualizar Playlist</button>
            </form>
        </div>
    );
};
